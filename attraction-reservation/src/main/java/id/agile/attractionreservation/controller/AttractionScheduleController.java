...
public class AttractionScheduleController {
	...
	public AttractionScheduleController(AttractionScheduleRepository attractionScheduleRepository) {
	...
	@GetMapping("/v1/attraction_schedule")
	public ResponseEntity<?> getAllAttractionSchedule(HttpServletRequest request)  {
